...
<html lang="en">
    ...
    <body>
        ...
        <!-- ##### Blog Area Start ##### -->
        <div id="banner">
            <c:if test="${sessionScope.acc.getRole_ID() eq 3}">
                <div id="cr"><a id="createblog" href="postblog">Post house</a></div>
            </c:if>
            <form action="posthouse" method="post">
                <div class="contain">
                    <h1 style="font-weight: 500;border-bottom: 1px solid gray">Post House</h1>
                    <h2 class="headingline">Rental address</h2>
                    <p>District</p>
                    <select name="district" class="slc">
                    ...
                    <h2 class="headingline">Description Information</h2>
                    <p>House Category</p>

                    <select name="category" class="slc">
                    ...
                    <p>Phone number</p>
                    <input type="text" value="${sessionScope.acc.getPhone_Number()}" readonly="">
                    <p>Rental price</p>
                    <input type="number" name="price"><span>₫</span>
                    <p>Area</p>
                    <input type="number" name="area"><span>m<sup>2</sup></span>
                    <p>Directions</p>

                    <select name="direction" class="slc">
                    ...
                    <h2 class="headingline">Images</h2>
                    <input type="file" name="image" multiple="">
                    <div style="margin: 0 auto;width: 200%;margin-top: 2em;"><input style="cursor: pointer;background-color: green;color: white" type="submit" value="Post" ></div>
                </div>
            </form>
        </div>
        <!-- ##### Blog Area End ##### -->
