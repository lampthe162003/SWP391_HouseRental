          ...
          <nav class="col-lg-2 d-none d-lg-block bg-light sidebar">
                    <div class="user_info">
                        <a href="#" class="clearfix">
                            ...
                            <div class="user_meta">
                                <div class="inner">
                                    <div class="user_name">${sessionScope.acc.getFullname()}</div>
                                    <div class="user_verify" style="color: #555; font-size: 0.9rem;">${sessionScope.acc.getPhone_Number()}</div>
                                </div>
                            </div>
                        </a>
                        <ul>
                            <li><span>Mã thành viên:</span> <span style="font-weight: 700;">${sessionScope.acc.getId()}</span></li>
                        </ul>
                    </div>
